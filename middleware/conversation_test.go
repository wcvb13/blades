...
func TestConversationBuffered(t *testing.T) {
    ...
    tests := []struct {
        ...
        },
        {
            ...
            initialHist: []*blades.Message{h3}, // should be overridden by session history
            sessionHist: []*blades.Message{h1, h2},
            wantHistTexts: []string{"h1", "h2"},
        },
        {
            ...
            initialHist: []*blades.Message{h4}, // should be overridden by trimmed session history
            sessionHist: []*blades.Message{h1, h2, h3},
            wantHistTexts: []string{"h3"},
        },
        {
