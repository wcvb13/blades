...
type HandleFunc struct {
	...
	HandleStream func(context.Context, *Prompt, ...ModelOption) stream.Streamable[*Message]
}
...
func (f *HandleFunc) RunStream(ctx context.Context, p *Prompt, opts ...ModelOption) stream.Streamable[*Message] {
